...
const copy: Record<string, LocaleCopy> = {
    ...
    it: {
        ...
        h1: "Unisci i Puntini da Stampare – Schede PDF Gratuite",
        subtitle:
            "Oltre 50 schede unisci i puntini gratuite da stampare, per difficoltà, tema ed età. Scarica in PDF — o crea il tuo puzzle personalizzato da una foto.",
        ...
        gridTitle: "Schede unisci i puntini da stampare",
        gridSub: (n: number, t: number) => `Mostrando ${n} di ${t} schede`,
        generatorHeading: "Non trovi quello che cerchi?",
        generatorSub:
            "Trasforma qualsiasi foto in un puzzle unisci i puntini personalizzato. Regola il numero di puntini, visualizza l'anteprima e scarica in PDF.",
        faqHeading: "Domande frequenti",
        faqItems: [
            {
                q: "Cos'è una scheda unisci i puntini?",
                a: "Una scheda unisci i puntini è un foglio di attività in cui puntini numerati formano un'immagine nascosta. Collegando i puntini da 1 a 2, da 2 a 3 e così via, l'immagine si rivela. Queste schede vengono usate per praticare il conteggio, sviluppare la motricità fine e offrire un'attività senza schermo per bambini e adulti.",
            },
            {
                q: "Queste schede da stampare sono davvero gratuite?",
                a: "Sì — ogni scheda unisci i puntini da stampare in questa raccolta è gratuita, senza filigrana e senza bisogno di registrazione. Clicca su un puzzle, apri la versione a grandezza naturale e stampa con le impostazioni standard Letter o A4.",
            },
            {
                q: "Per quale età sono adatte queste schede?",
                a: "Le schede sono contrassegnate per fascia d'età. Le schede facili con 10–25 puntini sono adatte ai 3–6 anni. Le schede medie con 25–60 puntini vanno bene per i 6–10 anni. Le schede difficili ed estreme con 60–200+ puntini sono progettate per i bambini dai 10 anni in su e gli adulti.",
            },
            {
                q: "Posso stampare le schede in formato PDF?",
                a: "Sì, tutte le schede unisci i puntini da stampare sono disponibili in PDF pronto per la stampa, formattato sia per carta A4 che US Letter. Basta cliccare su una scheda e scaricare il PDF direttamente, senza registrazione.",
            },
            {
                q: "Posso creare la mia scheda unisci i puntini da una foto?",
                a: "Sì. Il generatore qui sotto ti permette di caricare qualsiasi immagine e convertirla in un puzzle di puntini numerati che puoi regolare e scaricare in PDF.",
            },
            {
                q: "Come si stampa correttamente una scheda?",
