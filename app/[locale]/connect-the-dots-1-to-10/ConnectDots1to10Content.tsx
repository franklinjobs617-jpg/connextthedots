...
const copy: Record<string, LocaleCopy> = {
    ...
    it: {
        breadcrumbHome: "Home",
        breadcrumbCurrent: "Unisci i Puntini per Bambini",
        h1Prefix: "Schede Gratuite",
        h1Highlight: "Unisci i Puntini",
        h1Suffix: "per Bambini",
        heroBody: "Scarica le nostre schede unisci i puntini più semplici, pensate per i bambini piccoli che iniziano a contare. Puntini grandi, forme semplici e download PDF istantaneo — oppure crea il tuo disegno personalizzato da una foto, cosa che nessun'altra raccolta statica può offrire.",
        badgeEasiest: "Schede più Facili",
        badgeInstant: "Download PDF Istantaneo",
        badgeAge: "3-6 anni",
        lastUpdated: "Ultimo aggiornamento: 15 luglio 2026",
        gridTitle: "Le Nostre Schede Unisci i Puntini più Facili",
        gridSub: "Clicca su una scheda per vedere l'anteprima e scaricare il PDF. Tutte le schede sono gratuite, senza filigrana.",
        loadMore: (n) => `Vedi altro (${n} in più)`,
        showLess: "Vedi meno",
        whyTitle: "Perché Queste Schede sono Adatte ai Bambini",
        whyPara1: "Le nostre schede unisci i puntini più semplici sono il punto di partenza ideale per i bambini piccoli. Il numero ridotto di puntini mantiene le attività brevi e realizzabili, il che è essenziale per mantenere l'attenzione di un bambino piccolo. Ogni scheda completata dà al bambino un senso di realizzazione che rafforza la sua sicurezza.",
        whyPara2: "Queste schede aiutano a sviluppare il riconoscimento dei numeri, la motricità fine e la coordinazione occhio-mano — tre competenze fondamentali che preparano i bambini alla scrittura e alla matematica.",
        sourceLabel: "Fonte:",
        sourceText: "American Journal of Occupational Therapy — motricità fine nei bambini in età prescolare (in inglese)",
        skillsTitle: "Competenze che Svilupperà tuo Figlio:",
        skills: [
            "Riconoscimento dei Numeri: identificare e seguire i numeri in ordine",
            "Motricità Fine: esercitarsi nell'impugnatura della matita e nel tracciare linee",
            "Concentrazione e Pazienza: portare a termine un compito dall'inizio alla fine",
            "Riconoscimento delle Forme: identificare i contorni di animali, oggetti e motivi",
        ],
        howToTitle: "Come Usare Queste Schede",
        howToSteps: [
            { title: "Scegli una Scheda", body: "Sfoglia la raccolta qui sopra e scegli un disegno che tuo figlio adorerà — animali, forme o personaggi divertenti." },
            { title: "Scarica il PDF", body: "Clicca sul pulsante di download. Il file si aprirà in una nuova scheda — salvalo sul tuo dispositivo." },
            { title: "Stampa e Unisci!", body: "Stampa su carta standard. Dai a tuo figlio una matita colorata e lascia che unisca i puntini in ordine." },
        ],
        nextTitle: "Cosa Viene Dopo Queste Schede per Bambini?",
        nextBody: "Una volta che tuo figlio si trova a suo agio con queste schede più semplici, aumenta gradualmente la difficoltà. Queste schede di livello successivo aiutano a rafforzare le competenze di conteggio passo dopo passo.",
        nextLinks: [
            { href: "/it/printable-connect-the-dots/", title: "Tutte le Nostre Schede da Stampare", desc: "Sfoglia la collezione completa — schede facili, medie e difficili per tutte le età." },
            { href: "/it/connect-the-dots-for-adults/", title: "Unisci i Puntini Difficili", desc: "Puzzle estremi da 100 a 300+ puntini per una sfida più dettagliata." },
        ],
        generatorLink: "Oppure crea la tua con il nostro generatore",
        faqTitle: "Domande Frequenti",
        faqItems: [
            { q: "Per quale età sono adatte queste schede unisci i puntini per bambini?", a: "Queste schede sono pensate per bambini dai 3 ai 6 anni. I più piccoli possono iniziare con le forme più semplici, mentre i bambini più grandi possono usarle per rafforzare il riconoscimento dei numeri e la motricità fine." },
            { q: "Come stampo queste schede unisci i puntini?", a: "Clicca sul pulsante di download PDF di qualsiasi scheda. Apri il file PDF e seleziona Stampa. Scegli 'Adatta alla pagina' nelle impostazioni della stampante per il miglior risultato. Consigliamo carta A4 o Letter standard." },
            { q: "Queste schede per bambini sono davvero gratuite?", a: "Sì! Tutte le nostre schede unisci i puntini per bambini sono completamente gratuite da scaricare e stampare. Nessuna registrazione, nessun pagamento, nessuna filigrana. Sono destinate a uso personale ed educativo." },
            { q: "Cosa fare dopo queste schede per bambini?", a: "Una volta che tuo figlio è a suo agio con queste schede più semplici, prova le nostre schede di difficoltà media per la sfida successiva. Questa progressione graduale aiuta a costruire fiducia sviluppando le competenze di conteggio." },
            { q: "Gli insegnanti possono usare queste schede in classe?", a: "Assolutamente! Queste schede sono perfette per l'uso in classe. Gli insegnanti possono stamparle per i centri di matematica, il lavoro del mattino o come attività tranquilla." },
        ],
        ctaTitle: "Vuoi Schede Personalizzate?",
        ctaBody: "Usa il nostro generatore gratuito per creare puzzle unisci i puntini personalizzati da qualsiasi immagine. Perfetto per attività di apprendimento su misura!",
        ctaButton: "Prova il Generatore Gratuito",
        metaDescription: "Schede gratuite di unisci i puntini per bambini, facili e divertenti. Scarica in PDF o crea il tuo disegno personalizzato da una foto.",
    },
};
