// data.js
export const CDN_BASE_URL = "https://pub-476193f3c5084ebaabd517e2c8788715.r2.dev/printable/"; // 所有文件的基础路径
export const IMAGE_DEFAULT_WIDTH = 600;
export const IMAGE_DEFAULT_HEIGHT = 600; // 假设为正方形图片
...
export function createPrintableItem(id, title, puzzleFilename, solutionFilename, customDetails = {}) {
    ...
    return {
        ...
        difficulty: difficultyES, // 界面显示为西语
...
console.log('printablesData cargado con', Object.keys(printablesData).reduce((sum, key) => sum + printablesData[key].length, 0), 'elementos.');
