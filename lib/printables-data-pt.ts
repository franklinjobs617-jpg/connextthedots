  ...
  easy: [
    ...
    createPrintableItem(
      ...
      "easy-happy-sun-03-connect-the-dots-solution.webp",
      {
        ...
        popularity: 85,
        description:
          "Folha de unir pontos fácil com um sol radiante para crianças em pré-escola.",
      },
    ),
    createPrintableItem(
      "rainbow",
      ...
      "easy-rainbow-connect-the-dots-solution.webp",
      {
        ...
        dotRange: [1, 15],
        category: ["Natureza"],
        ageRecommendation: "3-5 anos",
        popularity: 92,
        description:
          "Um arco-íris feliz com nuvens para conectar, perfeito para aprender números de 1 a 15.",
      },
    ),
    createPrintableItem(
      "robot-01",
      ...
      "easy-robot-01-connect-the-dots-solution.webp",
      {
        ...
        tagColor: "bg-green-600",
        dotRange: [1, 25],
        category: ["Veículos", "Robôs"],
        ageRecommendation: "4-7 anos",
        popularity: 78,
        description:
          "Exercício fácil de unir pontos com um robô que acena. Ideal para desenvolver habilidades motoras.",
      },
    ),
    createPrintableItem(
      "sailboat",
      ...
      "easy-sailboat-connect-the-dots-solution.webp",
      {
        ...
        dotRange: [1, 20],
        category: ["Veículos"],
        ageRecommendation: "4-6 anos",
        popularity: 88,
        description:
          "Atividade de unir pontos de 1 a 20 com um veleiro na água. Ideal para a introdução numérica.",
      },
    ),
    createPrintableItem(
      "dinosaur-01",
      "Dinossauro de Pescoço Longo",
      ...
      "easy-dinosaur-01-connect-the-dots-solution.webp",
      {
        ...
        popularity: 89,
        description:
          "Folha de unir pontos de um dinossauro simpático para crianças em pré-escola.",
      },
    ),
    createPrintableItem(
      "dinosaur-02",
      ...
      "easy-dinosaur-02-connect-the-dots-solution.webp",
      {
        ...
        popularity: 82,
        description:
          "Conecte os números de 1 a 25 para descobrir este T-Rex divertido. Atividade fácil de unir pontos.",
      },
    ),
    createPrintableItem(
      "flower-pot",
      ...
      "easy-flower-pot-connect-the-dots-solution.webp",
      {
        ...
        popularity: 75,
        description:
          "Atividade de unir pontos de 1 a 18 com uma flor florescendo. Perfeita para atividades de primavera.",
      },
    ),
    createPrintableItem(
      "happy-sun-01",
      ...
      "easy-happy-sun-01-connect-the-dots-solution.webp",
      {
        ...
        popularity: 87,
        description:
          "Folha de unir pontos de um sol com raios. Excelente para praticar os primeiros números.",
      },
    ),
  ],
  medium: [
    ...
    createPrintableItem(
      ...
      "medium-castle-01-connect-the-dots-solution-1-80-numbers.webp",
      {
        ...
        tagColor: "bg-yellow-600",
        dotRange: [1, 80],
        category: ["Edifícios", "Fantasia"],
        ageRecommendation: "7-10 anos",
        popularity: 70,
        description:
          "Um quebra-cabeça de unir pontos de 1 a 80 com um castelo de conto de fadas.",
      },
    ),
    createPrintableItem(
      ...
      "medium-halloween-pumpkin-01-connect-the-dots-solution-1-65-numbers.webp",
      {
        ...
        popularity: 80,
        description:
          "Folha de unir pontos de uma abóbora. Diversão temática para Halloween.",
      },
    ),
    createPrintableItem(
      "lighthouse-01",
      ...
      "medium-lighthouse-01-connect-the-dots-solution-1-75-numbers.webp",
      {
        ...
        tagColor: "bg-yellow-600",
        dotRange: [1, 75],
        category: ["Edifícios", "Natureza"],
        ageRecommendation: "8-11 anos",
        popularity: 65,
        description:
          "Atividade detalhada de unir pontos de um farol frente ao mar. Uma cena relaxante para completar.",
      },
    ),
    createPrintableItem(
      "magical-unicorn-01",
      ...
      "medium-magical-unicorn-01-connect-the-dots-solution-1-70-numbers.webp",
      {
        ...
        tagColor: "bg-yellow-600",
        dotRange: [1, 70],
        category: ["Fantasia", "Animais"],
        ageRecommendation: "6-9 anos",
        popularity: 91,
        description:
          "Folha de unir pontos de um unicórnio mágico para fãs de fantasia.",
      },
    ),
    createPrintableItem(
      "mushroom-house-01",
      "Casa de Cogumelo Fantástica",
      ...
      "medium-mushroom-house-01-connect-the-dots-solution-1-70-numbers.webp",
      {
        ...
        popularity: 72,
        description:
          "Uma casa de cogumelo para conectar, perfeita para jovens aventureiros.",
      },
    ),
    createPrintableItem(
      "pirate-ship-01",
      "Navio Pirata Aventureiro",
      ...
      "medium-pirate-ship-01-connect-the-dots-solution-1-90-numbers.webp",
      {
        ...
        tagColor: "bg-yellow-600",
        dotRange: [1, 90],
        category: ["Veículos", "Aventura"],
        ageRecommendation: "8-12 anos",
        popularity: 86,
        description:
          "Desafio de unir pontos com um navio pirata. Navegue pelos mares conectando os números.",
      },
    ),
    createPrintableItem(
      "rocket-ship-01",
      ...
      "medium-rocket-ship-01-connect-the-dots-solution-1-60-numbers.webp",
      {
        ...
        tagColor: "bg-yellow-600",
        dotRange: [1, 60],
        category: ["Espaço", "Veículos"],
        ageRecommendation: "7-10 anos",
        popularity: 79,
        description:
          "Atividade de unir pontos de um foguete espacial para pequenos astronautas.",
      },
    ),
    createPrintableItem(
      "sports-car-01",
      ...
      "medium-sports-car-01-connect-the-dots-solution-1-85-numbers.webp",
      {
        ...
        popularity: 83,
        description:
          "Um carro esportivo para conectar. Perfeito para entusiastas de carros.",
      },
    ),
    createPrintableItem(
      "train-01",
      ...
      "medium-train-01-connect-the-dots-solution-1-60-numbers.webp",
      {
        ...
        popularity: 76,
        description:
          "Exercício de unir pontos de um trem clássico com muitos detalhes.",
      },
    ),
  ],
  hard: [
    createPrintableItem(
      ...
      "6-Advanced-Mountain-Landscape-Connect-the-Dots-Design-for-Adults-Over-100-dots-solution.avif",
      {
        ...
        ageRecommendation: "12+ anos",
        popularity: 60,
        description:
          "Folha avançada de unir pontos de uma paisagem de montanha para adultos. Descubra uma vista pitoresca.",
  ...
  extreme: [
    createPrintableItem(
      ...
      "7-Extreme-Difficulty-Mandala-Connect-the-Dots-Design-for-Adults-Over-200-dots-solution.avif",
      {
        ...
        tagColor: "bg-red-700",
        dotRange: [200, 300],
        category: ["Abstrato", "Arte"],
        ageRecommendation: "Adultos",
        popularity: 50,
        description:
          "Design de mandala complexo de dificuldade extrema para adultos. Um verdadeiro desafio intrincado.",
